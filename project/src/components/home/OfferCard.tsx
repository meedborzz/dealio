...
import { MapPin, Clock, ChevronRight, Heart, Calendar, ThumbsUp } from 'lucide-react';
...
export const OfferCard: React.FC<OfferCardProps> = ({ deal, onBook, distance }) => {
  ...
  return (
    <>
      <Card
        className="group cursor-pointer overflow-hidden rounded-2xl transition-all hover:shadow-lg hover:shadow-black/5 active:scale-[0.98] border-border bg-card"
        onClick={handleClick}
      >
