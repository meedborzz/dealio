/*
  # Fix confirm_booking_and_generate_qr function type mismatch

  1. Function Updates
    - Fix return type mismatch in confirm_booking_and_generate_qr function
    - Ensure all returned values match their declared types
    - Fix UUID casting issues in the return statement

  2. Changes Made
    - Updated the function to properly cast and return UUID types
    - Fixed the RETURN QUERY statement to match the declared return structure
...
BEGIN
    ...
    -- Update user loyalty points (e.g., 1 point per 10 DH spent)
    ...
    -- Return success and relevant data with proper type casting
    RETURN QUERY SELECT
        TRUE,
