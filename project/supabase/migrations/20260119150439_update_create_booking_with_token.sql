/*
  # Update Create Booking Function to Generate Guest Token

  1. Changes
    - Modify create_booking function to generate a booking_token for guest bookings
    - Token is only generated when user_id is NULL (guest bookings)
    - Token allows guests to access their booking without authentication
    
  2. Security
    - Token is a secure random UUID
    - Only generated for guest bookings
*/
...
BEGIN
  ...
  -- Generate a secure token for guest bookings
